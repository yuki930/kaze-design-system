          ...
          <Card>
            <div className={styles.statsCardInner}>
              <div className={styles.statsCardText}>
                ...
                <div className={styles.statsCardNumber}>63</div>
            ...
            <div className={styles.statsCardInner}>
              ...
              <div className={styles.barChart}>
                ...
                <div className={styles.bars}>
                  {[90, 60, 50, 40, 30].map((h, i) => (
                    <div
                      key={i}
                      className={styles.bar}
                      style={{ height: `${h}%`, background: "var(--color-accent-a)" }}
                    />
                  ))}
                </div>
              </div>
      ...
      <Section>
        ...
        <FeatureGrid columns={3}>
          ...
          <FeatureCard
            icon={<Zap size={24} />}
            title="軽量設計"
            description="スタイリングは純粋な CSS で、CSS-in-JS のランタイムが不要。gzip 約 23KB の軽量パッケージです。"
          />
        </FeatureGrid>
      </Section>
